[cybersecuritywithprivategpt-b4b4] Operating Details
====================================

Generated On: 2024-11-07 18:02:37 UTC
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-b4b4] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33967  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasunsam/cybersecuritywithprivategpt-b4b4-amd64 (https://hub.docker.com/r/kasunsam/cybersecuritywithprivategpt-b4b4-amd64)
...
.. important::
   docker run -d -p 39869:39869 -p 36427:36427 -p 35985:35985 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_ai_dag-cybersecuritywithprivategpt-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=39869  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=36427  \-\-env SOLUTIONVIPERVIZPORT=35985 \-\-env DOCKERUSERNAME='kasunsam'  \-\-env EXTERNALPORT=33967 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/cybersecuritywithprivategpt-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=35985
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=39869
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/cybersecuritywithprivategpt-b4b4-amd64
...
It can be accessed by entering: http://localhost:36427
...
.. important::
   http://localhost:35985/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:35985/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:35985/<html file>
...
[cybersecuritywithprivategpt-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-b4b4
...
.. important::
   https://cybersecuritywithprivategpt-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_ai_dag-cybersecuritywithprivategpt-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=39869, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45755, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41251, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34111, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34247, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34633, HPDEHOST=127.0.1.1, HPDEPORT=42335, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37669

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9577-cybersecuritywithprivategpt-b4b4,solution_preprocessing_ai_dag-cybersecuritywithprivategpt-b4b4, python-preprocess-4118-cybersecuritywithprivategpt-b4b4,solution_preprocessing_ai_dag-cybersecuritywithprivategpt-b4b4, python-ai-828-cybersecuritywithprivategpt-b4b4,solution_preprocessing_ai_dag-cybersecuritywithprivategpt-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
